    ...
    mainWindow.webContents.executeJavaScript(`
          ...
          messagesArray.forEach(entry => {
            if(entry.id.includes('chat-messages')) {
              ...
              if(entry.children[0].children[0].children[0].localName == 'img') {
                ...
                try {
                if(entry.children[0].children[0].children[1].children[0].children[0].children[0].children[0].src) {
                entry.children[0].children[0].children[1].children[0].children[0].children[0].children[0].src = imgsrc
                }
                } catch(e) {
                }
        ...
        function callback(props) {
          ...
          if(props[0].addedNodes[0].children[0]) {
            if(props[0].children[0].children[0].id.includes('message-reply-context')) {
              props[0].children[0].children[1].children[0].children[0].src = imgsrc
            } else {
